...
class EventPicturesControllerTest < ActionController::TestCase
  ...
  test "should create event_picture" do
    assert_difference('EventPicture.count') do
      post :create, event_picture: { event_id: @event_picture.event_id, picture: @event_picture.picture, picturename: @event_picture.picturename }
    end
  ...
  test "should update event_picture" do
    patch :update, id: @event_picture, event_picture: { event_id: @event_picture.event_id, picture: @event_picture.picture, picturename: @event_picture.picturename }
    assert_redirected_to event_picture_path(assigns(:event_picture))
  end
