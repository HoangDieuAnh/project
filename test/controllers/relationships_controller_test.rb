...
class RelationshipsControllerTest < ActionController::TestCase
  ...
  test "should create relationship" do
    assert_difference('Relationship.count') do
      post :create, relationship: { role: @relationship.role, society_id: @relationship.society_id, user_id: @relationship.user_id }
    end
  ...
  test "should update relationship" do
    patch :update, id: @relationship, relationship: { role: @relationship.role, society_id: @relationship.society_id, user_id: @relationship.user_id }
    assert_redirected_to relationship_path(assigns(:relationship))
  end
