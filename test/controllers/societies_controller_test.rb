...
class SocietiesControllerTest < ActionController::TestCase
  ...
  test "should create society" do
    assert_difference('Society.count') do
      post :create, society: { approved: @society.approved, name: @society.name, regNum: @society.regNum, website: @society.website }
    end
  ...
  test "should update society" do
    patch :update, id: @society, society: { approved: @society.approved, name: @society.name, regNum: @society.regNum, website: @society.website }
    assert_redirected_to society_path(assigns(:society))
  end
